...
Stand **v0.60.0** · 2026-06-30 · Branch `master` · Python/Flask · read-only Join-Pfad-Builder.
...
<div class="kz-card">
  ...
  <div class="kz-val">436 <small>Commits</small></div>
  <div class="kz-note">16 Sessions an 6 Kalendertagen (25.–30.06.)</div>
</div>

<div class="kz-card">
  <div class="kz-lbl">Testabdeckung</div>
  <div class="kz-val kz-good">88 <small>%</small></div>
  <div class="kz-note">436 Tests grün (10 skipped Oracle/MSSQL/PG) · 2041 Statements</div>
</div>
...
| Commits | 436 | 2026-06-25 → 06-30 · 6 Kalendertage · 16 Sessions · FF-Merges je AP (SDD-Branches) | gemessen |
| Aktuelle Version | v0.60.0 | SemVer je AP (`sync_version.py`) · von 0.1.0 in 16 Sessions | gemessen |
| Testabdeckung | 88 % | 2041 Statements, 240 ungedeckt · `pytest --cov` (core/web/launcher/config/app) | gemessen |
| Tests | 436 | alle grün · 10 skipped (optionale Oracle/MSSQL/PG-Live-Tests) · ~10 s Laufzeit | gemessen |
