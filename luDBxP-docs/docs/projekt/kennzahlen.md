...
Stand **v0.47.0** · 2026-06-28 · Branch `master` · Python/Flask · read-only Join-Pfad-Builder.
...
<div class="kz-card">
  ...
  <div class="kz-note">Kern/Produkt-APs (AP&#8209;1…60) umgesetzt · offener Backlog: AP&#8209;56/57, AP&#8209;61/62, AP&#8209;63, AP&#8209;19/35</div>
</div>

<div class="kz-card">
  <div class="kz-lbl">Tempo</div>
  <div class="kz-val">317 <small>Commits</small></div>
...
<div class="kz-card">
  ...
  <div class="kz-note">338 Tests grün (2 skip Oracle/MSSQL) · 1526 Statements</div>
</div>
...
| Commits | 317 | 2026-06-25 → 06-28 · 4 Kalendertage · 13 Sessions · FF-Merges je AP (SDD-Branches) | gemessen |
| Aktuelle Version | v0.47.0 | SemVer je AP (`sync_version.py`) · von 0.1.0 in 13 Sessions | gemessen |
| Testabdeckung | 90 % | 1526 Statements, 151 ungedeckt · `pytest --cov` (core/web/launcher/config/app) | gemessen |
| Tests | 338 | alle grün · 2 skipped (optionale Oracle/MSSQL-Live-Tests) · ~9 s Laufzeit | gemessen |
