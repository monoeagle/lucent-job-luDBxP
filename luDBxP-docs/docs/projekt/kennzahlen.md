...
Stand **v0.59.0** · 2026-06-30 · Branch `master` · Python/Flask · read-only Join-Pfad-Builder.
...
<div class="kz-card">
  ...
  <div class="kz-val">429 <small>Commits</small></div>
...
<div class="kz-card">
  ...
  <div class="kz-note">435 Tests grün (9 skipped Oracle/MSSQL/PG) · 2037 Statements</div>
</div>
...
| Commits | 429 | 2026-06-25 → 06-30 · 6 Kalendertage · 16 Sessions · FF-Merges je AP (SDD-Branches) | gemessen |
| Aktuelle Version | v0.59.0 | SemVer je AP (`sync_version.py`) · von 0.1.0 in 16 Sessions | gemessen |
| Testabdeckung | 88 % | 2037 Statements, 236 ungedeckt · `pytest --cov` (core/web/launcher/config/app) | gemessen |
| Tests | 435 | alle grün · 9 skipped (optionale Oracle/MSSQL/PG-Live-Tests) · ~10 s Laufzeit | gemessen |
