...
Stand **v0.48.0** · 2026-06-28 · Branch `master` · Python/Flask · read-only Join-Pfad-Builder.
...
<div class="kz-card">
  ...
  <div class="kz-note">356 Tests grün (2 skip Oracle/MSSQL) · 1671 Statements</div>
</div>
...
| Aktuelle Version | v0.48.0 | SemVer je AP (`sync_version.py`) · von 0.1.0 in 13 Sessions | gemessen |
| Testabdeckung | 91 % | 1671 Statements, 157 ungedeckt · `pytest --cov` (core/web/launcher/config/app) | gemessen |
| Tests | 356 | alle grün · 2 skipped (optionale Oracle/MSSQL-Live-Tests) · ~9 s Laufzeit | gemessen |
