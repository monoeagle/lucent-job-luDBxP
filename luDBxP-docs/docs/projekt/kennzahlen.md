...
Stand **v0.68.1** · 2026-07-02 · Branch `master` · Python/Flask · read-only Join-Pfad-Builder.
...
<div class="kz-card">
  ...
  <div class="kz-note">459 Tests grün (11 skipped Oracle/MSSQL/PG) · 2067 Statements</div>
</div>
...
| Aktuelle Version | v0.68.1 | SemVer je AP (`sync_version.py`) · von 0.1.0 in 18 Sessions | gemessen |
| Testabdeckung | 88 % | 2067 Statements, 241 ungedeckt · `pytest --cov` (core/web/launcher/config/app) | gemessen |
| Tests | 468 | alle grün · 11 skipped (optionale Oracle/MSSQL/PG-Live-Tests) · ~13 s Laufzeit | gemessen |
