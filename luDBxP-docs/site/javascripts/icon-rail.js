...
(function () {
  ...
  // ── Versionen ──────────────────────────────────────────────────────────
  const APP_VERSION   = '0.43.1';                       // ADAPT: bei Release anpassen
  const TEST_COUNT    = '308';                          // ADAPT: bei Release anpassen
  const TEST_DATE     = '2026-06-28';                   // ADAPT: bei Release anpassen
