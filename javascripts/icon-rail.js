...
(function () {
  ...
  // ── Versionen ──────────────────────────────────────────────────────────
  const APP_VERSION   = '0.68.0';                       // ADAPT: bei Release anpassen
  const TEST_COUNT    = '466';                          // ADAPT: bei Release anpassen
  const TEST_DATE     = '2026-07-02';                   // ADAPT: bei Release anpassen
